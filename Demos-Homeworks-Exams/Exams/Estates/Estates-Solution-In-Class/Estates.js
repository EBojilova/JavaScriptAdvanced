function processEstatesAgencyCommands(commands) {
    ...
    var Estate = (function() {
        ...
        Estate.prototype.toString = function() {
            var furnitured = this.getIsFurnitured() ?
                             "Yes" :
                             "No";
    ...
    var BuildingEstate = (function() {
        ...
        BuildingEstate.prototype.toString = function() {
            var elevator = this.getHasElevator() ?
                           "Yes" :
                           "No";
    ...
    var Offer = (function() {
        ...
        Offer.prototype.toString = function() {
            return "Estate = " + this.getEstate()
                                     .getName() +
                ", Location = " + this.getEstate()
                                      .getLocation() +
                ", Price = " + this.getPrice();
        }
        ...
        function formatQueryResults(offers) {
            ...
            if (offers.length == 0) {
                ...
                for (var i = 0; i < offers.length; i++) {
                    var offer = offers[i];
                    result += '  [Estate: ' + offer.getEstate()
                                                   .getName() +
                        ', Location: ' + offer.getEstate()
                                              .getLocation() +
